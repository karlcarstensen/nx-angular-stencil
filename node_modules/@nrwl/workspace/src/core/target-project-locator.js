...
class TargetProjectLocator {
    constructor(nodes, fileRead = file_utils_1.defaultFileRead) {
        ...
        this.cache = new Map();
        this.sortedWorkspaceProjects = project_graph_1.getSortedProjectNodes(nodes)
            .filter((node) => project_graph_1.isWorkspaceProject(node))
